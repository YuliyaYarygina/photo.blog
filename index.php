...
<!---->
<?
$article_home = $connection->query("SELECT * FROM articles WHERE id=1");
?>
<article class="article_home">

    <? foreach ($article_home as $article) : ?>

    <h2 class="article_home_title"> <?= $article['title']; ?> </h2>
    <p class="article_home_image"> <img src="img/home/<?= $article['image']; ?>" alt="my_photo"> </p>
        <div class="article_home_text"> <p class="article_home_text"> <?= $article['text']; ?> </p> </div>
    <? endforeach; ?>
