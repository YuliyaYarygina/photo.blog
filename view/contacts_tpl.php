...
<div class="container-contacts">
    ...
    <div class="container-email">
        <h3> Email </h3>
        <img src="../img/favicon/icons8-открытый-конверт-с-маркой-100.png">
        <p> <?= $config['email']; ?> </p>
    </div>

    <div>
        <h3> Телефон </h3>
        <img src="../img/favicon/icons8-телефон-100.png">
        <p> <?= $config['tel']; ?> </p>
    </div>

    <div>
        <h3> Facebook </h3>
        <a href="<?= $config['fb']; ?>" target="_blank" class="footer-link">
            <img src="../img/favicon/icons8-facebook.svg"> </a>
    </div>

    <div>
        <h3> Facebook </h3>
        <a href="<?= $config['inst']; ?>" target="_blank" class="footer-link">
            <img src="../img/favicon/icons8-instagram.svg"></a>
    </div>
